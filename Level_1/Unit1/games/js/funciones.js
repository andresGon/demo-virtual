	  ...
	  "<tr>"+
		...
		"<td width=\"590\" align=\"right\" valign=\"middle\" background=\"../../img/3.bg_heder.png\"><table width=\"556\" border=\"0\">"+
		  "<tr>"+
			...
			"<td width=\"81\" align=\"center\" valign=\"middle\"><a href=\"index.html\" onmouseout=\"MM_swapImgRestore()\" onmouseover=\"MM_swapImage('Image7','','../../img/7.btn_game_2.png',1)\"><img src=\"../../img/7.btn_game_2.png\" name=\"Image7\" width=\"76\" height=\"50\" border=\"0\" id=\"Image7\" /></a></td>"+
		  "</tr>"+
		"</table></td>"+
	  "</tr>"+
	"</table>";
...
function mostrarDivPrinc(idL)
{
	//alert("hola");
	if (idL == 1)
		document.location.href='games_1.html';
	else if (idL == 2)
		document.location.href='games_2.html';
	else if (idL == 3)
		document.location.href='games_3.html';
}