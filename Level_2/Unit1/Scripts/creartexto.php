...
}else if((in_array("Lesson 1 Exercise 9", $titulo))||(in_array("Lesson 1 Quiz part 2", $titulo))||(in_array("Lesson 3 Exer 9", $titulo))||(in_array("Lesson 2 Exercise 11", $titulo))||(in_array("Lesson 2 Exercise 12", $titulo))){
    $html="<html>
            <meta http-equiv=\"Content-Type\" content=\"text/html; charset=Windows-1252\">
            <body>
            <div align='center'><span style='color:red'>$str_titulo</span></div>
