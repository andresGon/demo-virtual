                              ...
                              '<td width="590" align="right" valign="middle" background="../img/3.bg_heder.png"><table width="556" border="0">'+
                                '<tr>'+
                                  ...
                                  '<td width="108" align="center" valign="bottom"><form id="form4" name="form4" method="post" action="">'+
                                    ...
                                    '</select>'+
                                  '</td>'+
                                  '<td width="81" align="center" valign="middle"><a href="../html/index.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage(\'Image7\',\'\',\'../img/7.btn_game_2.png\',1)"><img src="../img/7.btn_game_1.png" name="Image7" width="62" height="52" border="0" id="Image7" /></a></td>'+
                                '</tr>'+
                              '</table></td>'+
                            '</tr>'+
                          '</table>';
...
function mostrarDivPrinc(idL)
{
	...
	if (idL == 1)
		...
		document.location.href='L1_game_1.html';
	else if (idL == 3)
		document.location.href='L1_game_2.html';
	else if (idL == 4)
		document.location.href='L2_game_1.html';
	else if (idL == 5)
		document.location.href='L2_game_2.html';
	else if (idL == 6)
		document.location.href='L3_game_1.html';
}
